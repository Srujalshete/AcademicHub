...
function aboutsub() {
  return (
    ...
    <section className="bg-gray-100 py-16 px-8 sm:px-12 lg:px-16 -ml-3 -mr-3">
      <div className="container mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
          <div className="max-w-lg">
              <h2 className="text-3xl font-extrabold text-gray-900 sm:text-4xl">About Us</h2>
              <p className="mt-4 text-gray-900 text-lg">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed quis
  ...
  <img
    ...
    alt="About Us Image"
    className="object-cover w-full h-96 md:h-auto rounded-lg shadow-md"
  />
</div>
            ...
            <dl className="space-y-10 md:space-y-0 md:grid md:grid-cols-2 md:gap-x-8 md:gap-y-10">
              ...
              <div className="relative">
                <dt>
                  ...
                  <p className="font-heading ml-16 text-lg leading-6 font-bold text-gray-700">Easy to integrate SDK
                  </p>
                </dt>
        ...
        <div className="relative wrap overflow-hidden">
          ...
          <div className="mb-8 flex justify-between items-center w-full right-timeline">
            ...
            <div className="order-1 bg-gray-400 rounded-lg shadow-xl w-5/12 px-6 py-4">
              <h3 className="mb-3 font-bold text-gray-800 text-xl">Event Title 1</h3>
          ...
          <div className="mb-8 flex justify-between flex-row-reverse items-center w-full left-timeline">
            ...
            <div className="order-1 bg-gray-400 rounded-lg shadow-xl w-5/12 px-6 py-4">
              <h3 className="mb-3 font-bold text-gray-800 text-xl">Event Title 2</h3>
              <p className="text-gray-700 leading-tight">Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                Vestibulum in nisi commodo, aliquet velit ac, dapibus elit.</p>
            </div>
          </div>
          ...
          <div className="mb-8 flex justify-between items-center w-full right-timeline">
            ...
            <div className="order-1 bg-gray-400 rounded-lg shadow-xl w-5/12 px-6 py-4">
              <h3 className="mb-3 font-bold text-gray-800 text-xl">Event Title 3</h3>
              <p className="text-gray-700 leading-tight">Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                Vestibulum in nisi commodo, aliquet velit ac, dapibus elit.</p>
            </div>
          </div>
          ...
          <div className="mb-8 flex justify-between flex-row-reverse items-center w-full left-timeline">
            ...
            <div className="order-1 bg-gray-400 rounded-lg shadow-xl w-5/12 px-6 py-4">
              <h3 className="mb-3 font-bold text-gray-800 text-xl">Event Title 4</h3>
              <p className="text-gray-700 leading-tight">Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                Vestibulum in nisi commodo, aliquet velit ac, dapibus elit.</p>
            </div>
          </div>
          ...
          <div className="mb-8 flex justify-between items-center w-full right-timeline">
            ...
            <div className="order-1 bg-gray-400 rounded-lg shadow-xl w-5/12 px-6 py-4">
              <h3 className="mb-3 font-bold text-gray-800 text-xl">Event Title 5</h3>
              <p className="text-gray-700 leading-tight">Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                Vestibulum in nisi commodo, aliquet velit ac, dapibus elit.</p>
            </div>
          </div>

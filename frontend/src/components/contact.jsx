  ...
  <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
    <div className="md:flex gap-x-24 clear-left md:mb-16 mb-10">
      <div className=" md:mb-0 mb-4">
        <h2 className="font-manrope text-4xl font-semibold leading-10 mb-5 md:text-left text-center text-purple-600">Get In Touch</h2>
        ...
        <a href="/contact">
          <button className="w-36 h-12 rounded-full bg-purple-600 transition-all duration-700 hover:bg-purple-800 shadow text-white text-center text-base font-semibold leading-6">Contact Us</button>
        </a></div>
      </div>
